...
const anwisImages: MyImage[] = [
  {
    src: '/anwis-zaluzje-drewniane.jpg',
    alt: 'drewno i bambus',
    title: 'Żaluzje drewniane i bambusowe',
    download: '/catalogs/aniws_zaluzje_drewiane.pdf',
  },
  {
    src: '/anwis-moskitiery.jpg',
    alt: 'moskitiery',
    title: 'Moskitiery',
    download: '/catalogs/anwis_moskitiery.pdf',
  },
  {
    src: '/anwis-zaluzje-aluminiowe.jpg',
    alt: 'aluminiowe',
    title: 'Żaluzje aluminiowe',
    download: '/catalogs/anwis_zaluzje_nowe.pdf',
  },
  {
    src: '/anwis-zaluzja-aluminiowe-juun.jpg',
    alt: 'juun',
    title: 'Żaluzje aluminiowe Juun',
    download: '/catalogs/anwis_zaluzje_juun.pdf',
  },
  {
    src: '/anwis-zaluzja-aluminiowe-luna.jpg',
    alt: 'luna',
    title: 'Żaluzje aluminiowe Luna',
    download: '/catalogs/anwis_zaluzje_luna.pdf',
  },
];
