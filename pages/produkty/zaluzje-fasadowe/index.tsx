...
const anwisImages: MyImage[] = [
  {
    src: '/anwis-zaluzje-fasadowe-mini.jpg',
    alt: 'zaluzje fasadowe',
    title: 'Żaluzje fasadowe',
    download: '/catalogs/anwis_zaluzje_fasadowe.pdf',
  },
  {
    src: '/anwis-rolety-screen.jpg',
    alt: 'rolety screen',
    title: 'Rolety screen',
    download: '/catalogs/anwis_rolety_screen.pdf',
  },
];
