...
const medosImages: MyImage[] = [
  {
    src: '/medos-parapety-wewnetrzne-mini.jpg',
    alt: 'cennik',
    title: 'Cennik 2023',
    download: '/catalogs/medos-katalog-parapety-2023.pdf',
  },
];

const kratexImages: MyImage[] = [
  {
    src: '/parapet-wewnętrzny.jpg',
    alt: 'cennik',
    title: 'Cennik 2023',
    download: '/catalogs/cennik-parapetow-kratex.pdf',
  },
];
