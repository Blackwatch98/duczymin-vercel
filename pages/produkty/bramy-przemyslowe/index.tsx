...
const krispolImages: MyImage[] = [
  {
    src: '/krispol-brama-przemyslowa-mini.jpg',
    alt: 'bramy przemysłowe',
    title: 'Bramy przemysłowe',
    download: '/catalogs/krispol-katalog-przemyslowe-bramy-segmentowe.pdf',
  },
];

const wisniowskiImages: MyImage[] = [
  {
    src: '/wisniowski-bramy-przemyslowe-segmentowe.jpg',
    alt: 'segmentowe',
    title: 'Segmentowe',
    download: '/catalogs/bramy-przemyslowe-wisniowski.pdf',
  },
];
