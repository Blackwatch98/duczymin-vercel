...
const oknoplastImages: MyImage[] = [
  {
    ...
    alt: 'rolety',
    title: 'Rolety',
    download: 'https://oknoplast.com.pl/broszury/OKNOPLAST-Rolety.pdf',
  },
];

const krispolImages: MyImage[] = [
  {
    src: '/krispol-rolety-zewnetrzne-mini.jpg',
    alt: 'żaluzje i rolety',
    title: 'Żaluzje i rolety',
    download: '/catalogs/krispol-katalog-zaluzje-i-rolety.pdf',
  },
];
      ...
      <div className={styles.bodyContainer}>
        ...
        <div className={styles.descriptionContainer}>
          <div className={styles.descriptionPanel}>
            <p>
              Rolety firmowane marki KRISPOL zapewniają domownikom
              bezpieczeństwo i intymną atmosferę. Energooszczędność i komfort
              użytkowania. Estetykę i najwyższą jakość wykonania gwarantującą
              długoletnią i bezawaryjną pracę.
            </p>
          </div>
        </div>
