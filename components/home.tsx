            ...
            <div className={styles.carouselDiv}>
                ...
                <div className={styles.aboutContainer}>
                    <div className={styles.aboutDescriptionContainer}>
                        <p>
                            Firma DUCZYMIN od lat specjalizuje się w montażu i
                            serwisie systemów bramowych, ogrodzeniowych oraz
                            automatyki. Ponadto w naszej ofercie znajdziecie
                            Państwo okna oraz szeroką gamę osłon okiennych.
                            Firma nasza postawiła przede wszystkim na jakość,
                            trwałość i estetykę oferowanych produktów. Dlatego
                            ściśle współpracyjemy z najbardziej cenionymi
                            producentami na rynku. Oferowane produkty są
                            najwyższej jakości odpowiadające standardom
                            bezpieczeństwa, o najwyższym komforcie oraz
                            estetyce.
                        </p>
                        <p>
                            Swoim klientom oferujemy krótki termin realizacji,
                            fachowy montaż oraz atrakcyjne ceny. Nasza
                            współpraca obejmuje bezpłatne porady i pomiar.
                            Dysponujemy wyspecjalizowanymi ekipami monterskimi
                            oraz zapleczem magazynowym i logistycznym.
                        </p>
                        <p>
                            Naszymi działaniami wspieramy klientów na każdym
                            etapie doboru i użytkowania urządzeń. Jeśli
                            poszukują Państwo wysokiej jakości towarów,
                            doświadczenia i fachowego doradztwa – zapraszamy do
                            współpracy!
                        </p>
                    </div>
                </div>
